...
static const uint16_t PROGMEM eye_bg_12_9_16bit[108] = {
	//A1R8G8B8
	//looking at them as an image should be on the left are are labed as such (but these are right eyes on a person)
	...
	0x7fff, 0x7fff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0xffff, 0x5ca6, 0x5ca6,
...
static const uint16_t PROGMEM eye_fg_12_9_16bit[108]{
	//A1R8G8B8
	0x0000, 0x0000, 0x0000, 0x4279, 0xc279, 0xc279, 0xc279, 0x2db1, 0x0000, 0x0000, 0x0000, 0x0000,
	0x2db1, 0x4279, 0xc279, 0xc279, 0xb1d6, 0xb1d6, 0xb1d6, 0xb1d6, 0xb1d6, 0xc279, 0x0000, 0x0000,
	0x2db1, 0x633b, 0xe33b, 0x2db1, 0x0000, 0x0000, 0x0000, 0x0000, 0x2db1, 0x633b, 0xe33b, 0x2db1,
	0x633b, 0xe33b, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x633b, 0xe33b,
	0x633b, 0xe33b, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xe33b,
	0x633b, 0xe33b, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x633b, 0xe33b,
	0x0000, 0x633b, 0xe33b, 0x633b, 0x0000, 0x0000, 0x0000, 0x0000, 0x633b, 0x633b, 0xe33b, 0x0000,
	0x0000, 0x0000, 0x633b, 0xe33b, 0x633b, 0x633b, 0x633b, 0x633b, 0x633b, 0xe33b, 0x0000, 0x0000,
	0x0000, 0x0000, 0x0000, 0x633b, 0xe33b, 0xe33b, 0xe33b, 0xe33b, 0xe33b, 0x0000, 0x0000, 0x0000
};
...
public:
	...
	void drawEyes(int8_t dirX, int8_t dirY, EyeState left, EyeState right, int8_t leftEyebrows = 0, int8_t rightEyebrow = 0) {
		...
		if (left == EyeState::NORMAL) {
			...
			drawARGBBitmap(leftEyeX + eyeIrisOffestLeftX + CLAMP(dirX, -3, 2), eyeY + eyeIrisOffestY + dirY, eye_iris_6_6_16bit, 6, 6);
		...
		if (right == EyeState::NORMAL) {
			...
			drawARGBBitmap(rightEyeX + eyeIrisOffestRightX + CLAMP(dirX, -2, 3), eyeY + eyeIrisOffestY + dirY, eye_iris_6_6_16bit, 6, 6);
