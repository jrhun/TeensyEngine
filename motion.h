...
void getPitch() {
  IMU.readSensor();
  MadgwickQuaternionUpdate(IMU.getAccelX_mss(), IMU.getAccelY_mss(), IMU.getAccelZ_mss(), IMU.getGyroX_rads(), IMU.getGyroY_rads(), IMU.getGyroZ_rads(),  IMU.getMagY_uT(),  IMU.getMagX_uT(), IMU.getMagZ_uT());
